...
import dev.dietermai.projectselect.bots.ProjectExplorerBot;
import dev.dietermai.projectselect.bots.WorkbenchBot;

@RunWith(SWTBotJunit4ClassRunner.class)
public class ProjectExplorerSelectionTest {

	private static WorkbenchBot workbenchBot;
	private ProjectExplorerBot projectExplorer;
	...
	public void testCancelDoesNotSelectProject() {
		...
		List<String> selectedProjectNames = projectExplorer.getSelectedProjectNames();
	...
	public void testCancelDoesNotChangePrevSelection() {
		projectExplorer.selectProjects("Project02");
